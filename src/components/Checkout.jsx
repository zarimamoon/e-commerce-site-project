...
import { addToCart, removeFromCart, getTotals } from '../redux/cartSlice';
...
const Checkout = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    // Reset form fields (set all state variables to their initial values)
    setFirstName('');
    setLastName('');
    setUsername('');
    setEmail('');
  ...
  const productList = (product) => {
    ...
    return (
      <li className="list-group-item d-flex justify-content-between lh-sm" key={product.id}>
        ...
        <button onClick={handleRemoveFromCart} className="btn btn-danger btn-sm">
          Remove
        </button>
      </li>
    );
        ...
        <div className="row g-5">
          <div className="col-md-5 col-lg-4 order-md-last">
            <h4 className="d-flex justify-content-between align-items-center mb-3">
              ...
              <span className="badge bg-primary rounded-pill">{cart.length}<h5>Total: {cart.cartTotalAmount.toFixed(2)}</h5></span>
            </h4>
          ...
          <div className="col-md-7 col-lg-8">
            ...
            <form className="needs-validation" noValidate>
              <div className="row g-3">
                ...
                {/* Continue adding the rest of the form fields here with similar structure */}
                ...
                {/* Continue adding the rest of the form fields here */}
                <div className="col-12">
                ...
                {/* Add Address2, Country, State, Zip, and other form fields with similar structure */}
              ...
              <div className="row gy-3">
                <div className="col-md-6">
                  ...
                  <input
                    type="text"
                    className={`form-control ${formErrors.ccName ? 'is-invalid' : ''}`}
                    id="cc-name"
                    placeholder=""
                    value={ccName}
                ...
                <div className="col-md-6">
                  ...
                  <input
                    type="text"
                    className={`form-control ${formErrors.ccNumber ? 'is-invalid' : ''}`}
                    id="cc-number"
                    placeholder=""
                    value={ccNumber}
                ...
                <div className="col-md-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${formErrors.ccExpiration ? 'is-invalid' : ''}`}
                    id="cc-expiration"
                    placeholder=""
                    value={ccExpiration}
                    ...
                    autoComplete="cc-exp"
                  />
                  <div className="invalid-feedback">{formErrors.ccExpiration}</div>
                </div>
                ...
                <div className="col-md-3">
                  ...
                  <input
                    type="text"
                    className={`form-control ${formErrors.ccCvv ? 'is-invalid' : ''}`}
                    id="cc-cvv"
                    placeholder=""
                    value={ccCvv}
